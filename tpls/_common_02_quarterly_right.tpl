\begin{minipage}[t][\remainingHeight]{1.5\myLenTriCol}
...
{{- end -}}
\end{minipage}%
\hspace{2\myLenTriColSep}%
\begin{minipage}[t][\remainingHeight]{\dimexpr \textwidth -\myLenTriColSep -1.5\myLenTriCol}
