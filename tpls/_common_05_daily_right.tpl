...
\begin{tabularx}{\textwidth}{|X|ccccc|X|ccccc|}
  ...
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 1}}{{index .Cfg.DailyTracking.Tracking 0}}{{else}}&&&&{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 2}}{{index .Cfg.DailyTracking.Topics 1}}{{else}}{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 2}}{{index .Cfg.DailyTracking.Tracking 1}}{{else}}&&&&{{end}}
  \\ \hline
  {{if ge (len .Cfg.DailyTracking.Topics) 3}}{{index .Cfg.DailyTracking.Topics 2}}{{else}}{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 2}}{{index .Cfg.DailyTracking.Tracking 2}}{{else}}&&&&{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 4}}{{index .Cfg.DailyTracking.Topics 3}}{{else}}{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 4}}{{index .Cfg.DailyTracking.Tracking 3}}{{else}}&&&&{{end}}
  \\ \hline
  {{if ge (len .Cfg.DailyTracking.Topics) 5}}{{index .Cfg.DailyTracking.Topics 4}}{{else}}{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 5}}{{index .Cfg.DailyTracking.Tracking 4}}{{else}}&&&&{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 6}}{{index .Cfg.DailyTracking.Topics 5}}{{else}}{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 6}}{{index .Cfg.DailyTracking.Tracking 5}}{{else}}&&&&{{end}}
  \\ \hline
  {{if ge (len .Cfg.DailyTracking.Topics) 7}}{{index .Cfg.DailyTracking.Topics 6}}{{else}}{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 7}}{{index .Cfg.DailyTracking.Tracking 6}}{{else}}&&&&{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 8}}{{index .Cfg.DailyTracking.Topics 7}}{{else}}{{end}}
  &
  {{if ge (len .Cfg.DailyTracking.Topics) 8}}{{index .Cfg.DailyTracking.Tracking 7}}{{else}}&&&&{{end}}
  \\ \hline
\end{tabularx}
\end{small}%
\par\medskip%
